...
(
	...
	<p style="color:#333;font-size:14px;margin:20px 0;">
		V rámci této verze také vzniká dokumentace, která bude postupně rozšiřována a bude přehledně popisovat všechny dostupné funkce, možnosti a konfigurace systému.
	</p>
	<p style="color:#333;font-size:14px;margin:20px 0;">
		Tato aktualizace výrazně posouvá práci s obsahem směrem k větší přehlednosti, modularitě a budoucí rozšiřitelnosti.
	</p>
